/* ======================================================================== */
/* xedos_trans.cpp	                                                        */
/* This suboutine performs a move and evaluates its acceptance for xedos.	*/
...
/* the reaction coordinate line defined by SITE1 and SITE2 in defines.h.    */
/*																		    */
/* Written by Thomas Knotts 17 Jun 03.                                      */
/* Revised by Thomas Knotts 5 Aug 03 to make acceptance criteria contain an l^2/l^2 rather than an l^(n/1)/l^(n/2) */
/* Revised by Thomas Knotts 12 Sep 03 to make it work with all systems.     */
/* ======================================================================== */	
#ifdef XEDOS
#include "defines.h"
