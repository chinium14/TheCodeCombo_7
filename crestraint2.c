...
double crestraint2 (int ibox)
{
  ...
  /* ----------------------------------------- */
	...
	#ifdef ZHOU
		stresses[k][ia][0][0] += sxx * 0.5;
		stresses[k][ia][1][0] += sxx * 0.5;
		stresses[k][ia][1][1] += sxx * 0.5;
		stresses[k][ia][2][0] += sxx * 0.5;
		stresses[k][ia][2][1] += sxx * 0.5;
		stresses[k][ia][2][2] += sxx * 0.5;

		stresses[k][ib][0][0] += sxx * 0.5;
		stresses[k][ib][1][0] += sxx * 0.5;
		stresses[k][ib][1][1] += sxx * 0.5;
		stresses[k][ib][2][0] += sxx * 0.5;
		stresses[k][ib][2][1] += sxx * 0.5;
		stresses[k][ib][2][2] += sxx * 0.5;
	#endif
	#endif
