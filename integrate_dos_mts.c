...
/*                                                                          */
/* ************************************************************************ */
void integrate_dos_mts (int ibox, double vscal)
{

  int k = ibox;
  // The current forces are alreay backed up in ff_temp
  ...
  for(int l=0; l< box[k].boxns; l++){
		ff[k][l].x		= ff_short[k][l].x+ff_long[k][l].x;
		ff[k][l].y		= ff_short[k][l].y+ff_long[k][l].y;
		ff[k][l].z		= ff_short[k][l].z+ff_long[k][l].z;
	}
}
