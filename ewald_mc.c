...
/* ewald_mc.cpp                                                             */
/*                                                                          */
/*		This subroutine controls the calculation of the real, intra-        */
/* molecular and k-space parts of the ewald summation if MC is defined.     */
/*                                                                          */
/* ======================================================================== */
#ifdef MC
#ifdef EWALD
...
/*                                                                          */
/* ************************************************************************ */
void ewald_kspace_mc (int ibox, double *enkewald)
{
  /* ================================================================== */
  /*                                                                    */
...
void ewald_rspace_mc (int lb, int ub, int ibox, double *energy)
{
...
//	}// if valid interaction 
  ...
  /* contribution to the virial tensor to pviro[k].bond[i].              */
  /*                                                                    */
  /* ================================================================== */
#ifdef PRESSURE
