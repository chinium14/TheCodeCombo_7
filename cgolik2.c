...
void cnbnd_golik2(int ibox, double *energy)
{
...
//		  double lambda = gosol.lambda;
        ...
        config[k].hesx    += 2.0*(term3*dx2-force);
	      config[k].hesy    += 2.0*(term3*dy2-force);
	      config[k].hesz    += 2.0*(term3*dz2-force);
        ...
        config[k].hesx    += 2.0*(term4*dx2-force);
	      config[k].hesy    += 2.0*(term4*dy2-force);
	      config[k].hesz    += 2.0*(term4*dz2-force);
...
void cnbnd_dnagolik2(int ibox, double *energy)
{
...
/*    switch(flag){
    ...
    switch(flag){
	  ...
	  double term_force = qqerlambda*term1;
          ...
          config[k].hesx    += 2.0*(term3*dx2-term_force);
	  config[k].hesy    += 2.0*(term3*dy2-term_force);
	  config[k].hesz    += 2.0*(term3*dz2-term_force);
