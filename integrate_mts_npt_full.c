...
/* NPT-full cell fluctuations of Parinello and Rahman multiple time step    */
/* algorithms (This mode(XI/XO) is also specified in simul.input).          */
/*                                                                          */
...
/*                                                                          */
/* ************************************************************************ */
void integrate_mts_npt_full (int ibox)
{
  int k = ibox;
  ...
  /* ================================================================== */
  /*                                                                    */
  /* The NPT-XO-RESPA/NVT-XI-RESPA algorithm.                           */
  /*                                                                    */
  /* ================================================================== */
  ...
  /* -------------------------------------------------------- */
  if(sim.xRESPA[k] == 0) integrate_nhcp_full(dt_longh,k); 
  for (int j=0; j<sim.nsteps; j++){
	if(sim.xRESPA[k] == 1) integrate_nhcp_full(dt_shorth,k);
